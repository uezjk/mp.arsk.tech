...
import { InputItem } from "~components/ui/input.tsx";
...
export default function UtmUrlForm() {
  ...
  const copyFn = () => {
    ...
    ajax.json("/api/utm-url", { url: finalUrl });
  };

  return (
    <div class="bg-gray-100 p-4 md:p-8">
      <div class="flex flex-col gap-2">
        <InputItem title="投放网址" name="source" type="url" value={input.source} onInput={inputUpdate} />
        <InputItem
